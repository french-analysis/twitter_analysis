...
1) Build the backend server
  a) Define the needed data
  b) Setup the twitter API
  c) Retrieve the needed Data
2) Run the analytics
  a) Define 
  b) Define the tools and algorithms that we are using, why each of them is useful
  c) Implement them
